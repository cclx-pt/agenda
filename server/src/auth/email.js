  ...
  const html = `
    <div style="font-family:Segoe UI,Arial,sans-serif;max-width:560px;margin:0 auto;color:#111827">
      ...
      ${
        ...
        <p style="margin:0 0 10px;color:#065f46;font-size:14px">A tua inscrição está confirmada. Se quiseres contribuir, usa o método abaixo. Não é necessário enviar comprovativo.</p>
